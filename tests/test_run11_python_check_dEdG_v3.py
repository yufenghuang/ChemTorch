...
for i in range(10,20):
    feat_scaled[i, j] = feat_scaled[i, j] + 0.001
    nn_out3, d_nn_out3 = d_mlnn(feat_scaled, weights, biases, activation="sigmoid")
    print("==================")
    print(d_nn_out2[i, j])
    print((nn_out3[i, 0] - nn_out2[i, 0])/0.001)
    print((nn_out3.sum() - nn_out2.sum())/0.001)